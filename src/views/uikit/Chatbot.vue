<template>
     <div class="grid">
        ...
        <div class="chatbot-container">
            <div class="col-12 md:col-6">
               ...
               <div v-for="(question, index) in predefinedQuestions" :key="index" @click="selectQuestion(question)">
          {{ question }}
                  </div>
                  </div> 
        ...
        <div class="chat-container">
          <div v-for="(message, index) in messages" :key="index" class="message" :class="{ user: message.type === 'user', bot: message.type === 'bot' }">
            {{ message.text }}
          </div>
        </div>
  ...
  .questions-container {
    ...
    margin-left: auto; /* Esto alinea el contenedor a la derecha */
  }
